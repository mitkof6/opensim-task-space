...
#ifndef CA_UWATERLOO_ALUMNI_DWHARDER_QUATERNION
#define CA_UWATERLOO_ALUMNI_DWHARDER_QUATERNION
...
class NumberSystems_API Quaternion
{
private:
    T r, i, j, k;
...
//template NumberSystems_API std::ostream & operator << (std::ostream &, const Quaternion<double> &);
